...
export const openSource = {
  githubUserName: "dafnrs",
};

export const contact = {};

export const socialLinks: SocialLinksType = {
  email: "mailto:the@fenr1s.dev",
  linkedin: "https://www.linkedin.com/in/zhulian-ginev",
  github: "https://github.com/dafnrs",
  twitter: "https://x.com/lefnrs",
};
  ...
  data: [
    {
      ...
      skills: [
        "⚡ Building and operating production-grade cloud platforms on AWS",
        "⚡ Designing CI/CD pipelines and GitOps workflows for modern applications",
        "⚡ Advocating DevOps culture, mentoring teams, and improving engineering practices",
      ],
      softwareSkills: [
        {
          skillName: "Python",
